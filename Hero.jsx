...
const Hero = () => {
  ...
  return (
    <section id="home"
      ...
      <div className="flex flex-1 justify-center relative items-center xl:min-h-screen max-xl:py-40 bg-primary bg-cover bg-hero bg-center">
        <img
        src={bigShoeImage}
      ...
      <div className="flex sm:gap-6 gap-4 absolute  xl:-bottom-[-72%] xl:left-[48%]   ">
        {shoes.map((shoe)=>(
          <div key={shoe}>
            <ShoeCard
            imgURL={shoe}
